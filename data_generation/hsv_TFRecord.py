...
# 输出的TF格式文件
train_file = "D:\各种学科资料\病虫害识别\数据集\AI挑战赛\AgriculturalDisease_trainingset\\train_YCR_CB.tfrecords"
validation_file = "D:\各种学科资料\病虫害识别\数据集\AI挑战赛\AgriculturalDisease_validationset\\validation_YCR_CB.tfrecords"
# 用于写入TFRecord文件
